...
import { Mic, Users, LogOut, CheckCircle2, MessageSquareWarning, ArrowRight, Loader2 } from 'lucide-react'
  ...
  useEffect(() => {
    const fetchReports = async () => {
      ...
      if (error) {
        ...
        // SupabaseのデータをUI用のフォーマットに変換
        const formattedData: Report[] = data.map((row: any) => ({
          id: row.id,
          author: 'ゲストユーザー', // ※将来的にログイン機能を付けたら名前に置き換えます
